...
此程式主要目的為幫助正在學習化工系質能均衡課程的學生能夠快速算出複雜的質量守恆問題的程式，且在最後能夠生成我們熟悉的Flow table讓我們對數據能夠更好解讀，並且此程式具備變數分析的能力，只要提供的未知數不夠或過多都會給予警示。
...
&ensp;當發生這個情況我們必須講已知帶入solution當中，程式會自動自行做這件事情，就可以得到正常的答案。
